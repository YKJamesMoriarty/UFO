"""v20 (4-GPU) counterpart of scratch_arbitrary_pose_stress_tier2_driver.py --
identical methodology (40 trials, varied drop height + joint noise), only
MODEL_FOLDER changed, for direct v16-vs-v20 comparison.
"""
